...
import Page_Objects_IndiaLends.CC_SBILenderPage;
import Utility.Base;

public class CC_SBILenderScript extends Base {
	...
	public void CC_BasicDetailsPage() throws Exception 
	{
		...
		CC_SBILenderPage detailsPage = PageFactory.initElements(driver, CC_SBILenderPage.class);
