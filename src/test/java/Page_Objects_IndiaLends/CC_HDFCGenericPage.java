...
public class CC_HDFCGenericPage  extends Base {
...
protected WebDriver driver;
 ...
 //============= General Information ========================================= //
	...
	@FindBy(how=How.CSS, using="#btn_805")
	...
	public CC_HDFCGenericPage(WebDriver driver) {
		this.driver=driver;
	...
	public void check_Eligibility() throws Exception {
			...
			WebDriverWait pan = new WebDriverWait(driver, 70);
			pan.until(ExpectedConditions.visibilityOf(PanKarza));
	...
	public void general_Information() throws Exception {
		   ...
		   js1v.executeScript("window.scrollBy(0,500)");
			...
			//Office address
			 ...
			 WebElement education=driver.findElement(By.cssSelector("#employmentSelect"));
	...
	public void contact_Details() throws Exception {
			...
			//driver.findElement((By.cssSelector("#div_current_address_proof > label:nth-child(2)"))
			driver.findElement(By.xpath("//*[@id=\"div_current_address_proof\"]/label[1]")).click();
			...
			driver.findElement(By.cssSelector("#txtEmail")).sendKeys("test@test.com");
			
			slip.click();
			
			WebElement dirRel = driver.findElement(By.cssSelector("#residenceSelect"));
			Select dropdown14 = new Select(dirRel);
			dropdown14.selectByVisibleText("Owned");
