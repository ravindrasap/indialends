...
public class CC_ICICIGenericPage  extends Base {
...
//============================= Check Eligibility =======================================//
 ...
 //============= General Information ========================================= //
	...
	@FindBy(how=How.CSS, using="#btn_701")
	...
	@FindBy(how=How.CSS, using="#salary_slip_yes")
	private WebElement slip;
	
	@FindBy(how=How.CSS, using="#bankwise_controls_submit")
	private WebElement finalSubmit;
	
	
	public CC_ICICIGenericPage(WebDriver driver) {
		this.driver=driver;
	...
	public void enterBasicdetailsToCheckLoanEligibility() throws Exception 
	{
		...
		driver.findElement(By.cssSelector("#mainNav > div.container-fluid.md-pad10b.sm-pad0b > div.col-xs-12.col-sm-12.col-md-9.pad0 > div.collapse.navbar-collapse.navbar-ex1-collapse.pad10t.sm-pad0t.full-width > ul > li.dropdown > a"))
				.click();
		driver.findElement(By.cssSelector("#mainNav > div.container-fluid.md-pad10b.sm-pad0b > div.col-xs-12.col-sm-12.col-md-9.pad0 > div.collapse.navbar-collapse.navbar-ex1-collapse.pad10t.sm-pad0t.full-width > ul > li.dropdown.open > ul > li:nth-child(1) > a"))
				.click();
	...
	public void contact_Details() throws Exception {
			...
			Select dropdown17=new Select(relationship);
			dropdown17.selectByVisibleText("Saving");
			
			slip.click();
			
			WebElement addrProof=driver.findElement(By.cssSelector("#li_add_proof"));
			Select dropdown18=new Select(addrProof);
			dropdown18.selectByVisibleText("Passport");
			
			WebElement idProof=driver.findElement(By.cssSelector("#li_id_proof > select"));
			Select dropdown19=new Select(idProof);
			dropdown19.selectByVisibleText("Aadhaar Card");
