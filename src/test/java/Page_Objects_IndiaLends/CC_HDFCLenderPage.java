	...
	public class CC_HDFCLenderPage {
		...
		@FindBy(how=How.XPATH, using= "//*[@id=\"mainNav\"]/div[6]/div[1]/div[2]/ul/li[2]/ul/li[8]/a")
	...
	//	@FindBy(how=How.CSS, using="#li_office")
		...
		public CC_HDFCLenderPage(WebDriver driver) {
			this.driver=driver;
